...
const wordsWithEnergy = words.map(w => {
    return (Object.assign(Object.assign({}, w), { energy: defaultEnergy, probability: boltzmann(defaultEnergy) / z }));
});
